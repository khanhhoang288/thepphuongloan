...
$post_title = urlencode( html_entity_decode( wp_strip_all_tags( get_the_title() )));
...
<div class="<?php echo $share_box_class ?>">
	...
	<?php if( tie_get_option( 'share_tweet' ) ): ?>
		<li><a href="http://twitter.com/home?status=<?php echo $post_title; ?> <?php echo $post_link; ?> <?php if( tie_get_option( 'share_twitter_username' )) echo 'via @'.tie_get_option( 'share_twitter_username' ); ?>" class="social-twitter" rel="external" target="_blank"><i class="fa fa-twitter"></i> <span><?php _eti( 'Twitter' );?></span></a></li>
	<?php endif; ?>
